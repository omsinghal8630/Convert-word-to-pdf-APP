...
function Home() {
    ...
    const handleSubmit = async (event) => {
        ...
        } catch (error)
        {
            ...
            {
                setDownloadError("Error converting file. Please try again.", error.response.data.message);
            } else
            {
                setConvert("");
            }
                ...
                <div className="flex h-screen items-center justify-center">
                    <div className="border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg">
                        ...
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <button onClick={handleSubmit} disabled={!selectedFile} className="text-white bg-blue-500 hover:bg-blue-700 disabled:bg-gray-400 disabled:pointer-events-none duration-300 font-bold px-4 py-2 rounded-lg">
                                Convert File
                            </button>
